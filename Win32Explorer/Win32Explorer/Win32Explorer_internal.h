...
classes within the Win32Explorer project. */
namespace NExplorerplusplus
{
	const TCHAR WINDOW_NAME[]		= _T("Win32Explorer");
	const TCHAR CLASS_NAME[]		= _T("Win32Explorer");

	const TCHAR HELP_FILE_NAME[]	= _T("Win32Explorer Help.chm");

	/* The name of the XML file that preferences are
	saved to/loaded from. */
	const TCHAR XML_FILENAME[]		= _T("config.xml");

	const TCHAR LOG_FILENAME[]		= _T("Win32Explorer.log");
...
/* Used when setting Win32Explorer as the default
file manager. */
#define SHELL_DEFAULT_INTERNAL_COMMAND_NAME _T("openinWin32Explorer")
#define SHELL_DEFAULT_MENU_TEXT _T("Open In Win32Explorer")
